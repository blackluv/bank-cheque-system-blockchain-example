...
In production all the final mined blocks should be stored on and synced across all the network.
*/
...
/*
Basic cheque class to hold the data related to cheques
*/
class Cheque{
...
chequeCoin.addCheques(new Cheque('7863', 50, 'reciever', 'sender', Date.now(), 'cash', 'main branch', 'khan'));
chequeCoin.minePendingCheques();
